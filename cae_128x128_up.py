...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.deconv4 = nn.ConvTranspose2d(32, 32, 3, stride=1, padding=1)
        self.deconv3 = nn.ConvTranspose2d(32, 16, 3, stride=1, padding=1)
        self.deconv2 = nn.ConvTranspose2d(16, 8, 3, stride=1, padding=1)
        self.deconv1 = nn.ConvTranspose2d(8, 1, 3, stride=1, padding=1)
        ...
        self.dense3 = nn.Linear(2048, 16*16*32)
